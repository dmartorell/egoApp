...
- [ ] Manuales de estilo: _El País_, _AP Stylebook_, _Fundéu_, _El Universal (México)_.
- [ ] Literatura especializada: _El mejor oficio del mundo_ (García Márquez), _Manual de periodismo_ (Leñero y Marín), _Los elementos del estilo periodístico_ (James W. Carey).
